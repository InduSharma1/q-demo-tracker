<template>
    <div class="slds-notify_container">
        <div v-for="(toast, index) in toasts" :class="setToastType(toast.type)" :key="index"
            ...
            <span class="slds-icon_container slds-m-right_small slds-no-flex slds-align-top"
                ...
                <svg class="slds-icon slds-icon_small" aria-hidden="true">
                    <use :xlink:href="setIcon(toast.type)" />
                </svg>
            </span>
...
export default defineComponent({
    ...
    methods: {
        ...
        /** set dynamic icon */
        setIcon(icon) {
            return `/icons/utility-sprite/svg/symbols.svg#${icon}`;
        },
